...
public class AuthenticationHelper_Class {
    private static AuthenticationHelper_Class INSTANCE = null;
    private ISingleAccountPublicClientApplication mPCA = null;
    private String[] mScopes = { "User.Read", "Calendars.Read" };

    private AuthenticationHelper_Class(Context ctx) {
    ...
    public static synchronized AuthenticationHelper_Class getInstance(Context ctx) {
        if (INSTANCE == null) {
            INSTANCE = new AuthenticationHelper_Class(ctx);
        }
    ...
    public static synchronized AuthenticationHelper_Class getInstance() {
        if (INSTANCE == null) {
